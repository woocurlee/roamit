  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <div className="text-sm text-white/55">오늘도 새로운 동네로</div>
          <h1 className="mt-1 text-3xl font-bold tracking-tight">Roamit</h1>
        </div>
        <div className="rounded-full border border-white/10 bg-white/10 px-3 py-2 text-xs text-white/70">
          서울 탐험
        </div>
      </div>
      ...
      <Card className="overflow-hidden border-white/10 bg-white/10 text-white shadow-2xl backdrop-blur">
        <CardContent className="relative p-6">
          ...
          <div className="absolute right-12 top-12 h-36 w-36 rounded-full border border-white/5" />
          <p className="text-sm text-emerald-200">역을 뽑고, 근처 장소를 기록해보세요</p>
